            ...
            <Col lg="4">
              <Card>
                <CardBody>
                  ...
                  <h6>
                    Giới thiệu bản thân : Là một người vui vẻ ... &ensp;
                    <u>Xem thêm</u>
                  </h6>
              ...
              <Card>
                <CardBody>
                  <h5 className="mb-4 p-2">Mục tiêu cá nhân</h5>{" "}
                  <div
                    className="p-2"
                    style={{ borderBottom: "0.5px solid black" }}
                  >
                    <h6>Mục tiêu : Thể dục thể thao</h6>
                    <h6>Mô tả : Thể thao trong giờ nghỉ giải lao.</h6>
                    <h6>Ý nghĩa : Nâng cao sức khỏe cho bản thân và anh em.</h6>
                    <h6>Bắt đầu: 01/03/2021 Kết thúc: 01/12/2021</h6>
                    <h6>Riêng tư: Nhóm. Trạng thái: Đang diễn ra.</h6>
                  </div>
                  <div
                    className="p-2"
                    style={{ borderBottom: "0.5px solid black" }}
